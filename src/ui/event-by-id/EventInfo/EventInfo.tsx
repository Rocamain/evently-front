...
export const EventInfo: React.FC<EventInfoProps> = ({
  ...
  return (
    <div className="lg:bg-none lg:border lg:border-none rounded-lg lg:m-w-[240px] lg:border-shadowColor">
      <div className="lg:sticky lg:top-0 w-full lg:h-fit">
        ...
        <div className="relative pt-6 lg:pb-6 lg:pt-0 bg-white sm:px-10 md:px-20 lg:px-4 lg:border lg:border-gray-300 lg:border-t-0 lg:rounded-b-lg">
