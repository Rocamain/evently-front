  ...
  return (
    <div className="lg:pb-6 lg:bg-none lg:border lg:border-none rounded-lg lg:w-[400px] lg:border-shadowColor">
      <div className="lg:sticky lg:top-0 w-full lg:h-fit">
        <div className="py-6 px-5 sm:px-10  md:px-20 lg:px-0 bg-gray-200/40 lg:bg-white lg:border-gray-300 lg:border lg:border-b-0 lg:rounded-t-lg sm:md:max-w-xl md:max-w-5xl">
